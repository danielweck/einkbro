package info.plateaukao.einkbro_.setting

import info.plateaukao.einkbro_.R
import info.plateaukao.einkbro_.activity.SettingRoute
...
enum class LinkSettingItem(
    ...
    ProjectSite(R.string.project_site, R.drawable.ic_home, "https://github.com/plateaukao/einkbro_"),
    LatestRelease(
        R.string.latest_release,
        R.drawable.icon_earth,
        "https://github.com/plateaukao/einkbro_/releases"
    ),
    Facebook(R.string.twitter, R.drawable.icon_earth, "https://twitter.com/einkbro_"),
    ChangeLogs(
        R.string.changelogs,
        R.drawable.icon_earth,
        "https://github.com/plateaukao/einkbro_/blob/main/CHANGELOG.md"
    ),
    Contributors(
        R.string.contributors,
        R.drawable.icon_copyright,
        "https://github.com/plateaukao/einkbro_/blob/main/CONTRIBUTORS.md"
    ),
    Medium(R.string.medium_articles, R.drawable.ic_reader, "https://medium.com/einkbro_"),
    Manual(R.string.manual, R.drawable.ic_reader, "https://einkbro_.github.io/overview.html", span = 2)
}
