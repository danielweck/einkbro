package info.plateaukao.einkbro_
...
import info.plateaukao.einkbro_.activity.BrowserActivity
import info.plateaukao.einkbro_.activity.SettingActivity
import info.plateaukao.einkbro_.browser.AdBlock
...
import info.plateaukao.einkbro_.service.InstapaperRepository
...
class EinkBro_Application : Application() {
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidContext(this@EinkBro_Application)
            modules(myModule)
        }
            ...
            if (ContextCompat.checkSelfPermission(
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                    ActivityCompat.requestPermissions(
                        (this@EinkBro_Application as BrowserActivity),
    ...
    companion object {
        lateinit var instance: EinkBro_Application
            private set
    }
}
