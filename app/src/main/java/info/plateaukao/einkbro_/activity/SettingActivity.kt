...
import info.plateaukao.einkbro_.activity.SettingRoute.About
import info.plateaukao.einkbro_.activity.SettingRoute.Backup
import info.plateaukao.einkbro_.activity.SettingRoute.Behavior
import info.plateaukao.einkbro_.activity.SettingRoute.ChatGPT
import info.plateaukao.einkbro_.activity.SettingRoute.DataControl
import info.plateaukao.einkbro_.activity.SettingRoute.Gesture
import info.plateaukao.einkbro_.activity.SettingRoute.Main
import info.plateaukao.einkbro_.activity.SettingRoute.Misc
import info.plateaukao.einkbro_.activity.SettingRoute.Search
import info.plateaukao.einkbro_.activity.SettingRoute.StartControl
import info.plateaukao.einkbro_.activity.SettingRoute.Toolbar
import info.plateaukao.einkbro_.activity.SettingRoute.Ui
import info.plateaukao.einkbro_.activity.SettingRoute.UserAgent
import info.plateaukao.einkbro_.activity.SettingRoute.valueOf
...
import info.plateaukao.einkbro_.preference.TranslationTextStyle
import info.plateaukao.einkbro_.setting.ActionSettingItem
import info.plateaukao.einkbro_.setting.BooleanSettingItem
import info.plateaukao.einkbro_.setting.DividerSettingItem
import info.plateaukao.einkbro_.setting.LinkSettingItem
import info.plateaukao.einkbro_.setting.ListSettingWithClassItem
import info.plateaukao.einkbro_.setting.ListSettingWithEnumItem
import info.plateaukao.einkbro_.setting.ListSettingWithStrResIdItem
import info.plateaukao.einkbro_.setting.NavigateSettingItem
import info.plateaukao.einkbro_.setting.ProgressActionSettingItem
import info.plateaukao.einkbro_.setting.SettingItemInterface
import info.plateaukao.einkbro_.setting.SettingScreen
import info.plateaukao.einkbro_.setting.ValueSettingItem
import info.plateaukao.einkbro_.setting.VersionSettingItem
...
import info.plateaukao.einkbro_.view.GestureType
import info.plateaukao.einkbro_.view.compose.MyTheme
import info.plateaukao.einkbro_.view.dialog.DialogManager
import info.plateaukao.einkbro_.view.dialog.PrinterDocumentPaperSizeDialog
