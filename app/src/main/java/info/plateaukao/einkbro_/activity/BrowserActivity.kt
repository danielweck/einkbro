package info.plateaukao.einkbro_.activity
...
import info.plateaukao.einkbro_.R
import info.plateaukao.einkbro_.browser.AlbumController
import info.plateaukao.einkbro_.browser.BrowserContainer
import info.plateaukao.einkbro_.browser.BrowserController
import info.plateaukao.einkbro_.database.Article
import info.plateaukao.einkbro_.database.Bookmark
import info.plateaukao.einkbro_.database.BookmarkManager
import info.plateaukao.einkbro_.database.Highlight
import info.plateaukao.einkbro_.database.Record
import info.plateaukao.einkbro_.database.RecordDb
import info.plateaukao.einkbro_.databinding.ActivityMainBinding
import info.plateaukao.einkbro_.epub.EpubManager
import info.plateaukao.einkbro_.preference.AlbumInfo
import info.plateaukao.einkbro_.preference.ChatGPTActionInfo
import info.plateaukao.einkbro_.preference.ConfigManager
import info.plateaukao.einkbro_.preference.DarkMode
import info.plateaukao.einkbro_.preference.FabPosition
import info.plateaukao.einkbro_.preference.FontType
import info.plateaukao.einkbro_.preference.GptActionDisplay
import info.plateaukao.einkbro_.preference.HighlightStyle
import info.plateaukao.einkbro_.preference.NewTabBehavior
import info.plateaukao.einkbro_.preference.TranslationMode
import info.plateaukao.einkbro_.preference.toggle
import info.plateaukao.einkbro_.search.suggestion.SearchSuggestionViewModel
import info.plateaukao.einkbro_.service.ClearService
import info.plateaukao.einkbro_.unit.BackupUnit
import info.plateaukao.einkbro_.unit.BrowserUnit
import info.plateaukao.einkbro_.unit.BrowserUnit.createDownloadReceiver
import info.plateaukao.einkbro_.unit.HelperUnit
import info.plateaukao.einkbro_.unit.HelperUnit.toNormalScheme
import info.plateaukao.einkbro_.unit.IntentUnit
import info.plateaukao.einkbro_.unit.LocaleManager
import info.plateaukao.einkbro_.unit.ShareUtil
import info.plateaukao.einkbro_.unit.ViewUnit
import info.plateaukao.einkbro_.unit.pruneWebTitle
import info.plateaukao.einkbro_.unit.toRawPoint
import info.plateaukao.einkbro_.util.Constants.Companion.ACTION_DICT
import info.plateaukao.einkbro_.util.TranslationLanguage
import info.plateaukao.einkbro_.view.EBToast
import info.plateaukao.einkbro_.view.EBWebView
import info.plateaukao.einkbro_.view.MultitouchListener
import info.plateaukao.einkbro_.view.SwipeTouchListener
import info.plateaukao.einkbro_.view.dialog.BookmarkEditDialog
import info.plateaukao.einkbro_.view.dialog.DialogManager
import info.plateaukao.einkbro_.view.dialog.ReceiveDataDialog
import info.plateaukao.einkbro_.view.dialog.SendLinkDialog
import info.plateaukao.einkbro_.view.dialog.TextInputDialog
import info.plateaukao.einkbro_.view.dialog.TranslationLanguageDialog
import info.plateaukao.einkbro_.view.dialog.TtsLanguageDialog
import info.plateaukao.einkbro_.view.dialog.compose.ActionModeView
import info.plateaukao.einkbro_.view.dialog.compose.BookmarksDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.ContextMenuDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.ContextMenuItemType
import info.plateaukao.einkbro_.view.dialog.compose.FastToggleDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.FontBoldnessDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.FontDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.LanguageSettingDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.MenuDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.ReaderFontDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.ShowEditGptActionDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.TouchAreaDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.TranslateDialogFragment
import info.plateaukao.einkbro_.view.dialog.compose.TranslationConfigDlgFragment
import info.plateaukao.einkbro_.view.dialog.compose.TtsSettingDialogFragment
import info.plateaukao.einkbro_.view.handlers.GestureHandler
import info.plateaukao.einkbro_.view.handlers.MenuActionHandler
import info.plateaukao.einkbro_.view.handlers.ToolbarActionHandler
import info.plateaukao.einkbro_.view.viewControllers.ComposeToolbarViewController
import info.plateaukao.einkbro_.view.viewControllers.FabImageViewController
import info.plateaukao.einkbro_.view.viewControllers.OverviewDialogController
import info.plateaukao.einkbro_.view.viewControllers.TouchAreaViewController
import info.plateaukao.einkbro_.view.viewControllers.TwoPaneController
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.DeeplTranslate
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.GoogleTranslate
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.Gpt
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.HighlightText
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.Idle
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.Naver
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.Papago
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.SelectParagraph
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.SelectSentence
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.SplitSearch
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuState.Tts
import info.plateaukao.einkbro_.viewmodel.ActionModeMenuViewModel
import info.plateaukao.einkbro_.viewmodel.AlbumViewModel
import info.plateaukao.einkbro_.viewmodel.BookmarkViewModel
import info.plateaukao.einkbro_.viewmodel.BookmarkViewModelFactory
import info.plateaukao.einkbro_.viewmodel.ExternalSearchViewModel
import info.plateaukao.einkbro_.viewmodel.InstapaperViewModel
import info.plateaukao.einkbro_.viewmodel.RemoteConnViewModel
import info.plateaukao.einkbro_.viewmodel.SplitSearchViewModel
import info.plateaukao.einkbro_.viewmodel.TRANSLATE_API
import info.plateaukao.einkbro_.viewmodel.TranslationViewModel
import info.plateaukao.einkbro_.viewmodel.TtsViewModel
...
open class BrowserActivity : FragmentActivity(), BrowserController {
    ...
    override fun newATab() {
        // fix: https://github.com/plateaukao/einkbro_/issues/343
        if (searchOnSite) {
            hideSearchPanel()
        }
...
//                "NoCoin Filter List" to "https://filters.adtidy.org/extension/chromium/filters/242.txt"
    ...
    override fun showSaveEpubDialog() = dialogManager.showSaveEpubDialog { uri ->
        if (uri == null) {
            epubManager.showWriteEpubFilePicker(writeEpubFilePickerLauncher, ebWebView.title ?: "einkbro_")
        } else {
            saveEpub(uri)
        }
    }
