package info.plateaukao.einkbro_.epub
...
import info.plateaukao.einkbro_.unit.BrowserUnit.getResourceAndMimetypeFromUrl
...
class EpubManager(private val context: Context) : KoinComponent {
    ...
    private suspend fun internalSaveEpub(
        ...
        val domain = webUri.host ?: "EinkBro_"
    ...
    private fun createBook(domain: String, bookName: String): Book = Book().apply {
        ...
        metadata.addAuthor(Author(domain, "EinkBro_ App"))
    }
