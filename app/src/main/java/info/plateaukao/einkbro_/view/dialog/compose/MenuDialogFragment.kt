package info.plateaukao.einkbro_.view.dialog.compose
...
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.CloseTab
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.CopyLink
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.OpenEpub
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.OpenHome
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.OpenWith
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.Quit
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.SaveEpub
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.SavePdf
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.Settings
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.ShareLink
import info.plateaukao.einkbro_.view.dialog.compose.MenuItemType.Shortcut
