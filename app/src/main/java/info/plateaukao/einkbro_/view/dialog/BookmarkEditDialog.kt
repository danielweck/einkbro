...
import info.plateaukao.einkbro_.databinding.DialogEditBookmarkBinding
...
class BookmarkEditDialog(
    ...
    fun show() {
        ...
        dialogManager.showOkCancelDialog(
            title = activity.getString(info.plateaukao.einkbro_.R.string.menu_save_bookmark),
            view = binding.root,
            okAction = {
    ...
    private fun upsertBookmark(bookmark: Bookmark) {
        try {
            ...
            e.printStackTrace()
            EBToast.show(activity, info.plateaukao.einkbro_.R.string.toast_error)
        }
    }
}