...
class BackupUnit(
    ...
    fun restoreBackupData(context: Context, uri: Uri): Boolean {
        try {
            ...
            while (zipEntry != null) {
                ...
                Log.w("backup", "filepath: $filepath")
    ...
    companion object {
        private const val DATABASE_PATH = "/data/data/info.plateaukao.einkbro_/databases/"
        private const val SHARED_PREFS_PATH = "/data/data/info.plateaukao.einkbro_/shared_prefs/"
    }
}
